...
table = [["Output", "Big fibre", "Small fibre"], ["fibre height [mm]", round(2 * height1 * 9.4 / 1000, 5), round(2 * height2 * 9.4 / 1000, 5)], ["fibre width[mm]", round(2 * width1 * 9.4 / 1000, 5), round(2 * width2 * 9.4 / 1000, 5)], ["fibre lenght [mm]", round(lenght1 * 9.4 / 1000, 5), round(lenght2 * 9.4 / 1000, 5)]]
