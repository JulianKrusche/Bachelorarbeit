...
table = [["Output", "Big fibre", "Small fibre"], ["fibre height [mm]", round(height1 * 9.4 / 1000, 5), round(height2 * 9.4 / 1000, 5)], ["fibre width[mm]", round(width1 * 9.4 / 1000, 5), round(width2 * 9.4 / 1000, 5)], ["fibre lenght [mm]", round(lenght1 * 9.4 / 1000, 5), round(lenght2 * 9.4 / 1000, 5)]]
