...
print("Big axis:", axis1)
pfp_x1, pfp_y1, pfp_z1, Xc1, Yc1, Zc1, height1, width1, lenght1 = ellipse_along_axis(coord_data, axis1, set_number_of_layers = 32)
print("Small axis:",axis2)
pfp_x2, pfp_y2, pfp_z2, Xc2, Yc2, Zc2, height2, width2, lenght2 = ellipse_along_axis(coord_data, axis2, set_number_of_layers = 32)
...
table = [["Output", "Big fibre", "Small fibre"], ["fibre height [mm]", round(height1 * 9.4 / 1000, 4), round(height2 * 9.4 / 1000, 4)], ["fibre width[mm]", round(width1 * 9.4 / 1000, 4), round(width2 * 9.4 / 1000, 4)], ["fibre lenght [mm]", round(lenght1 * 9.4 / 1000, 4), round(lenght2 * 9.4 / 1000, 4)], ["C0 [mm]", round(h01 * 9.4 / 1000, 4),""], ["probe height [mm]", round(probe_height * 9.4 / 1000, 4), ""], ["distance fibre lines [mm]", round(linedistace * 9.4 / 1000, 4), ""]]
