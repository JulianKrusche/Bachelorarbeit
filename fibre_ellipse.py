...
pfp_x1, pfp_y1, pfp_z1, Xc1, Yc1, Zc1, height1, width1, lenght1 = ellipse_along_axis(coord_data, axis1)
print("Small axis:",axis2)
pfp_x2, pfp_y2, pfp_z2, Xc2, Yc2, Zc2, height2, width2, lenght2 = ellipse_along_axis(coord_data, axis2)
